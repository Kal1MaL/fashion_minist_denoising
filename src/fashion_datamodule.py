...
class FashionMNISTPriorDataset(Dataset):
    """
    In-memory Dataset for real-time assembly of multi-modal priors.
    """
    ...
    def __getitem__(self, idx):
        ...
        data_dict = {
            ...
            'spatial_prior': self.spatial_prior,  # [1, 28, 28]
            'label': label,
            'sigma': sigma_est
        }
